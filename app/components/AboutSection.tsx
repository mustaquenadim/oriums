...
export default function AboutSection() {
  return (
    <section id="about" className="relative z-10 bg-background px-6 py-24">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              We are a dynamic team of passionate software developers,
              designers, and technology experts dedicated to crafting innovative
              digital solutions. With over a decade of experience, we've helped
              businesses across various industries transform their digital
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-muted-foreground">
                  Agile development methodology for faster, more efficient
                  delivery
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-muted-foreground">
                  Dedicated team of experts with diverse technical expertise
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="mt-1 rounded-full bg-primary/10 p-1">
                ...
                <p className="text-muted-foreground">
                  Customer-centric approach with focus on long-term partnerships
                </p>
              </div>
            </div>
          </motion.div>
