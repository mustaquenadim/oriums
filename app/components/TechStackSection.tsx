...
const technologies = [
  {
    ...
    logo: "/placeholder.svg?height=60&width=120&text=React",
    color: "#61DAFB",
  },
  {
    name: "Next.js",
    category: "Framework",
    description: "Full-stack React framework with server-side rendering and static site generation",
    logo: "/placeholder.svg?height=60&width=120&text=Next.js",
    color: "#000000",
  },
  {
    name: "TypeScript",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=TypeScript",
    color: "#3178C6",
  },
  {
    name: "Node.js",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Node.js",
    color: "#339933",
  },
  {
    name: "Python",
    category: "Language",
    description: "High-level programming language perfect for AI, ML, and backend development",
    logo: "/placeholder.svg?height=60&width=120&text=Python",
    color: "#3776AB",
  },
  {
    name: "React Native",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=React+Native",
    color: "#61DAFB",
  },
  {
    name: "Flutter",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Flutter",
    color: "#02569B",
  },
  {
    name: "AWS",
  ...
  },
  {
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Docker",
    color: "#2496ED",
  },
  {
    name: "PostgreSQL",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=PostgreSQL",
    color: "#336791",
  },
  {
    name: "MongoDB",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=MongoDB",
    color: "#47A248",
  },
  {
    name: "GraphQL",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=GraphQL",
    color: "#E10098",
  },
  {
    name: "Kubernetes",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Kubernetes",
    color: "#326CE5",
  },
  {
    name: "TensorFlow",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=TensorFlow",
    color: "#FF6F00",
  },
  {
    name: "Solidity",
    category: "Blockchain",
    description: "Programming language for writing smart contracts on Ethereum blockchain",
    logo: "/placeholder.svg?height=60&width=120&text=Solidity",
    color: "#363636",
  },
  {
    name: "Vue.js",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Vue.js",
    color: "#4FC08D",
  },
  {
    name: "Angular",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Angular",
    color: "#DD0031",
  },
  {
    name: "Firebase",
    category: "Backend",
    description: "Google's platform for building and running mobile and web applications",
    logo: "/placeholder.svg?height=60&width=120&text=Firebase",
    color: "#FFCA28",
  },
  {
    name: "Redis",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Redis",
    color: "#DC382D",
  },
  {
    name: "Tailwind CSS",
    ...
    logo: "/placeholder.svg?height=60&width=120&text=Tailwind",
    color: "#06B6D4",
  },
]
...
export default function TechStackSection() {
  ...
  const handleTechHover = (tech: (typeof technologies)[0], event: React.MouseEvent) => {
    setHoveredTech(tech)
    setIsPaused(true)
  ...
  return (
    <section className="relative z-10 py-24 bg-background overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <h2 className="text-4xl mb-4 text-foreground">Our Technology Stack</h2>
        ...
        >
          {Object.entries(categoryIcons).map(([category, Icon], index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 bg-gradient-to-r ${categoryColors[category as keyof typeof categoryColors]} rounded-full flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform`}
                >
              ...
              >
                <div className="relative p-6 bg-card rounded-2xl shadow-lg border hover:shadow-2xl transition-all duration-300 group-hover:border-primary/50">
                  ...
                  <div className="text-center">
                    <h3 className="font-semibold text-sm mb-1 text-card-foreground">{tech.name}</h3>
                    <div
                      className={`inline-block px-2 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${categoryColors[tech.category as keyof typeof categoryColors]
                        } text-white`}
                    >
                      {tech.category}
                    </div>
            ...
            >
              <div className="bg-popover rounded-xl shadow-2xl border p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-2">
                  <div
                    className={`w-8 h-8 rounded-full bg-gradient-to-r ${categoryColors[hoveredTech.category as keyof typeof categoryColors]
                      } flex items-center justify-center`}
                  >
                    {(() => {
                      const Icon = categoryIcons[hoveredTech.category as keyof typeof categoryIcons]
                      return <Icon className="w-4 h-4 text-white" />
                    })()}
                  </div>
                  <div>
                    <h4 className="font-semibold text-popover-foreground">{hoveredTech.name}</h4>
        ...
        >
          <h3 className="text-2xl font-semibold mb-4 text-foreground">Ready to Build with Modern Technology?</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our expert team stays current with the latest technologies to deliver cutting-edge solutions for your
            business
          </p>
          <motion.button
