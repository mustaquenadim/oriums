...
const additionalBenefits = [
  {
    ...
    description: "99% of our projects are delivered on schedule with our proven agile methodology",
  },
  {
    icon: Shield,
    title: "Risk-Free Partnership",
    description: "30-day money-back guarantee and comprehensive insurance coverage",
  },
  {
    icon: Target,
    title: "ROI-Focused Solutions",
    description: "Average 300% ROI improvement for clients within the first year",
  },
  {
    icon: Zap,
    title: "Rapid Prototyping",
    description: "See your ideas come to life with our 2-week MVP development process",
  },
  {
    icon: TrendingUp,
...
const testimonialHighlights = [
  {
    quote: "Oriums transformed our business with their innovative approach and exceptional execution.",
    author: "Sarah Johnson, CEO of TechCorp",
    rating: 5,
  },
  {
    quote: "The best development partner we've ever worked with. Highly recommended!",
    author: "Michael Chen, CTO of StartupX",
    rating: 5,
  },
  {
    quote: "Outstanding quality, on-time delivery, and excellent communication throughout.",
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <div className="inline-flex items-center rounded-full border bg-secondary px-4 py-2 mb-6">
            ...
            <span className="text-sm font-semibold text-secondary-foreground">Why Choose Oriums</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            When you partner with Oriums, you're not just hiring a development team – you're gaining a strategic ally
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          ...
          <div className="space-y-4">
            {mainReasons.map((reason, index) => (
              <motion.div
                key={reason.id}
                className={`p-6 rounded-2xl border cursor-pointer transition-all duration-300 ${activeReason === reason.id
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-1 text-card-foreground">{reason.title}</h3>
                    <p className="text-sm text-primary font-medium mb-2">{reason.subtitle}</p>
                  ...
                  activeReason === reason.id && (
                    ...
                    >
                      <div className="text-center mb-8">
                        ...
                        <h3 className="text-2xl font-bold mb-2 text-card-foreground">{reason.title}</h3>
                        <p className="text-primary font-semibold">{reason.subtitle}</p>
                      </div>

                      <p className="text-muted-foreground mb-8 text-center">{reason.description}</p>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h3 className="text-2xl font-semibold text-center mb-12">Additional Benefits You'll Love</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {additionalBenefits.map((benefit, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300 ${hoveredBenefit === index ? "bg-primary text-white" : "text-primary"
                      }`}
                  >
                    <benefit.icon className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2 text-card-foreground">{benefit.title}</h4>
        ...
        >
          <h3 className="text-3xl font-bold mb-4">Ready to Experience the Oriums Difference?</h3>
          <p className="text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join hundreds of successful companies who've chosen Oriums as their trusted technology partner. Let's build
