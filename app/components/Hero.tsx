    ...
    <section className="relative flex min-h-screen items-center justify-center bg-background px-6 pt-32 pb-24 md:px-12 lg:px-24">
      <div className="relative z-10 max-w-[1200px] text-center">
        ...
        >
          ...
          <span className="mr-2 text-sm font-semibold text-card-foreground">100%</span>
          <span className="text-sm text-muted-foreground">money back guarantee, if you're not satisfied with our service</span>
        </motion.div>
        <motion.h1
        ...
        >
          Use AI as your design ally, not as a replacement. Effortlessly generate sitemaps and wireframes for marketing
          websites in minutes.
        </motion.p>
        <motion.button
