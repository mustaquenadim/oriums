  ...
  return (
    <section className="relative z-10 px-6 py-24 bg-background">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-4xl mb-4 text-foreground">Let's Build Something Amazing Together</h2>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="p-8 bg-primary rounded-2xl text-primary-foreground">
              ...
              <Button variant="secondary" size="lg" className="bg-background text-primary hover:bg-background/90 shadow-md hover:shadow-lg">
                Schedule a Call
              </Button>
            </div>
          </motion.div>
          ...
          >
            <form className="space-y-6 p-8 bg-card rounded-2xl shadow-lg border">
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="first-name" className="block text-sm font-medium mb-2 text-card-foreground">
                    First Name
                  </label>
                  <Input id="first-name" required />
                </div>
                <div>
                  <label htmlFor="last-name" className="block text-sm font-medium mb-2 text-card-foreground">
                    Last Name
                  </label>
              ...
              <div>
                ...
                <Textarea id="message" rows={4} placeholder="Tell us about your project..." required />
              </div>
              <Button type="submit" size="lg" className="w-full shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-all duration-200">
