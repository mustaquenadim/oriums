...
const projects = [
  {
    ...
    description:
      "A modern e-commerce solution with advanced analytics and inventory management.",
  ...
  },
  {
    ...
    description:
      "Real-time financial analytics dashboard with interactive charts and reporting.",
  ...
  },
  {
    ...
    description:
      "Cross-platform fitness tracking app with social features and AI coaching.",
  ...
  },
  {
    ...
    description:
      "Centralized smart home control system with voice commands and automation.",
  ...
  },
  {
    ...
    description:
      "Advanced content generation platform powered by machine learning algorithms.",
...
export default function PortfolioSection() {
  return (
    <section id="portfolio" className="relative z-10 px-6 py-24 bg-muted/30">
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Explore some of our latest projects that showcase our expertise
