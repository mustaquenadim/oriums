      ...
      <div className='max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Visit us at any of our offices worldwide or schedule a virtual
            meeting
          </p>
        </motion.div>
        ...
        >
          <div className='bg-card border p-8 rounded-2xl shadow-sm max-w-4xl mx-auto'>
            ...
            <p className='text-muted-foreground mb-6'>
              No problem! We offer virtual consultations and can work with
              clients anywhere in the world.
            </p>
            <div className='flex flex-wrap justify-center gap-4'>
              <CalButton className='gap-2'>📹 Schedule Video Call</CalButton>
