      ...
      <div className='relative max-w-6xl mx-auto'>
        ...
        >
          ...
          <p className='text-xl text-primary-foreground/80 max-w-3xl mx-auto mb-8'>
            Join 500+ satisfied clients who have transformed their ideas into
            successful digital products with Oriums.
          </p>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-16'>
          {ctaOptions.map((option, index) => (
            ...
            >
              ...
              {option.title.toLowerCase().includes('schedule') ? (
                <CalButton
        ...
        >
          <div className='bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 rounded-2xl p-8 max-w-2xl mx-auto'>
            ...
            <p className='text-primary-foreground/80 mb-6'>
              Download our free project planning guide and get a clear roadmap
              for your digital transformation.
            </p>
            <Button
              variant='outline'
              className='bg-primary-foreground/20 hover:bg-primary-foreground/30 text-primary-foreground border-primary-foreground/30 gap-2'
            >
              📥 Download Free Guide
            </Button>
          </div>
